...
//           "https://vaccine-system-hxczh3e5apdjdbfe.southeastasia-01.azurewebsites.net/Customer/get-customer"
//         );
...
//     console.log("Customer ID being updated:", editingCustomer);
//     console.log("Data being sent:", JSON.stringify(formData, null, 2)); // Log rõ ràng hơn
...
//     if (formData.bloodType === "Choose blood type") {
//       notification.error({
//         message: "Update Failed",
...
//     try {
//       await axios.put(
//         `https://vaccine-system-hxczh3e5apdjdbfe.southeastasia-01.azurewebsites.net/Customer/update-customer/${editingCustomer}`,
//         formData,
//         {
//           headers: {
...
//                     className={style["select-box"]}
//                   >
//                     <option disable selected>Choose blood type</option>
...
const CustomerTable = () => {
  ...
  return (
    <div className={style.customer_container}>
      ...
      <button onClick={() => handleOpenModal(123)}>Open Modal</button>
      <ChildrenList
